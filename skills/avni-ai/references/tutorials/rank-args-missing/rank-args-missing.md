...
Workflow: test rank args missing
...
**Setup Required:**
```python
# Fixtures: grps, vals, ties_method, ascending, na_option, pct, exp
```
...
*Source: test_rank.py:434 | Complexity: Advanced | Last updated: 2026-02-20*