# How To: Multifunc Numba Udf Frame
...
Workflow: test multifunc numba udf frame
...
**Setup Required:**
```python
# Fixtures: agg_kwargs, expected_func
```
...
*Source: test_numba.py:196 | Complexity: Intermediate | Last updated: 2026-02-20*