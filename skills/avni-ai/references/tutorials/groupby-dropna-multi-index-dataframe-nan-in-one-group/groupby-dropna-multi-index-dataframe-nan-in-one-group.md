# How To: Groupby Dropna Multi Index Dataframe Nan In One Group
...
Workflow: test groupby dropna multi index dataframe nan in one group
...
**Setup Required:**
```python
# Fixtures: dropna, tuples, outputs, nulls_fixture
```
...
*Source: test_groupby_dropna.py:32 | Complexity: Intermediate | Last updated: 2026-02-20*