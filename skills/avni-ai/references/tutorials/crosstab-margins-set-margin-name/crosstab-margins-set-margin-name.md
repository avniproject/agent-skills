# How To: Crosstab Margins Set Margin Name
...
Workflow: test crosstab margins set margin name
...
### Step 15: Assign exp_rows.name = 'TOTAL'
...
### Step 19: Assign msg = 'margins_name argument must be a string'

```python
msg = 'margins_name argument must be a string'
```

### Step 20: Call crosstab()
...
*Source: test_crosstab.py:158 | Complexity: Advanced | Last updated: 2026-02-20*