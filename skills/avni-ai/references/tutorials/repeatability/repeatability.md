...
### Step 3: Assign val = self.rfunc.view(...)
...
### Step 9: Assign val = self.rfunc(...)

```python
val = self.rfunc(0, 6, size=1000, dtype=dt)
```

### Step 10: Assign val = self.rfunc.byteswap(...)
...
*Source: test_randomstate.py:346 | Complexity: Advanced | Last updated: 2026-02-20*