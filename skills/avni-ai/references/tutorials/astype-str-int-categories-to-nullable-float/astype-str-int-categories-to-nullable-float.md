# How To: Astype Str Int Categories To Nullable Float
...
Workflow: test astype str int categories to nullable float
...
*Source: test_astype.py:74 | Complexity: Intermediate | Last updated: 2026-02-20*