...
### Step 2: Assign actual = np.random.hypergeometric(...)
...
### Step 5: Assign actual = np.random.hypergeometric(...)
...
### Step 8: Assign actual = np.random.hypergeometric(...)
...
### Step 11: Assign actual = np.random.hypergeometric(...)
...
### Step 14: Assign actual = np.random.hypergeometric(...)
...
*Source: test_random.py:697 | Complexity: Advanced | Last updated: 2026-02-20*