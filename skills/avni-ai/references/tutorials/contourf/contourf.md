...
### Step 11: Call ax1.contourf()

```python
ax1.contourf(X_dates, Y_dates, Z_ranges)
```

### Step 12: Call ax2.contourf()

```python
ax2.contourf(X_dates, Y_ranges, Z_ranges)
```

### Step 13: Call ax3.contourf()
...
*Source: test_datetime.py:293 | Complexity: Advanced | Last updated: 2026-02-20*