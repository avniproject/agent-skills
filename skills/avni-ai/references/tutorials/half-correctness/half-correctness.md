...
### Step 2: Assign a_bits = self.finite_f16.view(...)
...
### Step 3: Assign a_sgn = value

```python
a_sgn = (-1.0) ** ((a_bits & 32768) >> 15)
```

### Step 4: Assign a_exp = value

```python
a_exp = np.array((a_bits & 31744) >> 10, dtype=np.int32) - 15
```

### Step 5: Assign a_man = value
...
### Step 12: Assign bad_index = value
...
*Source: test_half.py:255 | Complexity: Advanced | Last updated: 2026-02-20*