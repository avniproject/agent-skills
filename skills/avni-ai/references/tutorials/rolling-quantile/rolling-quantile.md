...
Workflow: test rolling quantile
...
**Setup Required:**
```python
# Fixtures: interpolation, roll_frame
```
...
### Step 3: Assign result = r.quantile(...)
...
*Source: test_groupby.py:132 | Complexity: Advanced | Last updated: 2026-02-20*