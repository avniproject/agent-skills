# How To: Maybe Promote Timedelta64 With Any
...
Workflow: test maybe promote timedelta64 with any
...
**Setup Required:**
```python
# Fixtures: timedelta64_dtype, any_numpy_dtype
```
...
### Step 6: Assign exp_val_for_scalar = pd.Timedelta.to_timedelta64(...)
...
*Source: test_promote.py:390 | Complexity: Advanced | Last updated: 2026-02-20*