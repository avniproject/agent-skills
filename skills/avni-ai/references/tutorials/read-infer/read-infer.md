...
**Setup Required:**
```python
# Fixtures: compression_ext, get_random_path
```
...
### Step 4: Assign compression = self._extension_to_compression.get(...)
...
### Step 6: Call df.to_pickle()

```python
df.to_pickle(p1, compression=None)
```

### Step 7: Call self.compress_file()

```python
self.compress_file(p1, p2, compression=compression)
```

### Step 8: Assign df2 = pd.read_pickle(...)
...
*Source: test_pickle.py:370 | Complexity: Advanced | Last updated: 2026-02-20*