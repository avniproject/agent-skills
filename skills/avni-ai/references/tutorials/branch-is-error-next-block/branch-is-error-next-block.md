# How To: Branch Is Error Next Block
...
Workflow: test branch is error next block
...
### Step 4: Assign b = Branch(...)

```python
b = Branch(self.b, next_block, BasicBlock(9), Branch.IS_ERROR)
```

### Step 5: Assign b.negated = True
...
*Source: test_emitfunc.py:234 | Complexity: Intermediate | Last updated: 2026-02-20*