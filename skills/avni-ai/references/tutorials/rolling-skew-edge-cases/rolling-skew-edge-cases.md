# How To: Rolling Skew Edge Cases
...
Workflow: test rolling skew edge cases
...
### Step 3: Assign x = d.rolling.skew(...)
...
### Step 7: Assign x = d.rolling.skew(...)
...
### Step 11: Assign x = d.rolling.skew(...)
...
*Source: test_rolling_skew_kurt.py:172 | Complexity: Advanced | Last updated: 2026-02-20*