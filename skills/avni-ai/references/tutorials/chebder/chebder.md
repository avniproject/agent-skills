...
### Step 4: Assign res = cheb.chebder(...)
...
### Step 7: Assign res = cheb.chebder(...)
...
### Step 10: Assign res = cheb.chebder(...)
...
*Source: test_chebyshev.py:326 | Complexity: Advanced | Last updated: 2026-02-20*